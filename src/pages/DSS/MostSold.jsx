...
import { getMostSold } from '../../redux/medicine/action';
...
const MostSold = () => {
    ...
    const handelSubmit = (e) => {
        e.preventDefault();
        dispatch(getMostSold(sdate, edate));
    };

    return (
        <div className="mt-20 px-8">
            <p>Page</p>
            <p className='font-bold text-3xl'>{loading ? "Loading..." : "Most Sold Medicine"}</p>
            ...
            <form onSubmit={handelSubmit}>
                <div className="flex flex-wrap lg:w-4/12 sm:mx-auto sm:mb-2 -mx-2 transition duration-500 bg-white dark:bg-secondary-dark-bg rounded-lg shadow-lg p-6">
                    <p className='text-sm'>Provide date range to get the most sold item.</p>

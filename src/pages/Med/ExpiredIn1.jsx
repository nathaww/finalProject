...
import { expiresin1 } from '../../redux/medicine/action';
import { Tooltip } from 'flowbite-react';
import { useNavigate } from 'react-router-dom';
import Loading from '../../components/Loading';


const ExpiredIn1Month = () => {

  const nav = useNavigate();
  let dispatch = useDispatch();

  const { ex1, loading } = useSelector(state => state.medicines);
  ...
  return (
    <div className="mt-20 px-8">
      <p>Page</p>
      <p className='font-bold text-3xl'>Expires in 1 Month</p>
...
export default ExpiredIn1Month